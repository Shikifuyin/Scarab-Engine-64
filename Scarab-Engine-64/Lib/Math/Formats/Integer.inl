...
template<UInt INT_BYTES> const Integer<INT_BYTES> Integer<INT_BYTES>::Zero      = Integer<INT_BYTES>( 0 );
template<UInt INT_BYTES> const Integer<INT_BYTES> Integer<INT_BYTES>::One       = Integer<INT_BYTES>( 1 );
template<UInt INT_BYTES> const Integer<INT_BYTES> Integer<INT_BYTES>::Infinity  = Integer<INT_BYTES>( FLOAT_INFINITE );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( UInt8 iValue )
{
    Assert( INT_BYTES >= 8 );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( Int8 iValue )
{
    Assert( INT_BYTES >= 8 );
    MemZero( m_arrDigits, INT_BYTES );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( UInt16 iValue )
{
    Assert( INT_BYTES >= 8 );
    MemZero( m_arrDigits, INT_BYTES );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( Int16 iValue )
{
    Assert( INT_BYTES >= 8 );
    MemZero( m_arrDigits, INT_BYTES );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( UInt32 iValue )
{
    Assert( INT_BYTES >= 8 );
    MemZero( m_arrDigits, INT_BYTES );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( Int32 iValue )
{
    Assert( INT_BYTES >= 8 );
    MemZero( m_arrDigits, INT_BYTES );
    m_arrDigits[0] = (UShort)( iValue & 0x0000ffff );
...
template<UInt INT_BYTES>
Integer<INT_BYTES>::Integer( Int64 iValue )
{
    Assert( INT_BYTES >= 8 );
    MemZero( m_arrDigits, INT_BYTES );
    m_arrDigits[0] = (UShort)( iValue & 0x000000000000ffffi64 );
...
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator UInt8() const {
    return (UInt8)( m_arrDigits[0] & 0x00ff );
}
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator Int8() const {
    Int8 iRes = (Int8)( m_arrDigits[0] & 0x007f );
    if ( m_arrDigits[INT_DIGIT_LAST] & 0x8000 != 0 )
        iRes |= 0x80;
    return iRes;
}
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator UInt16() const {
    return m_arrDigits[0];
}
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator Int16() const {
    Int16 iRes = (Int16)( m_arrDigits[0] & 0x7fff );
    if ( m_arrDigits[INT_DIGIT_LAST] & 0x8000 != 0 )
        iRes |= 0x8000;
    return iRes;
}
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator UInt32() const {
    return ( ( ((UInt32)m_arrDigits[1]) << 16 ) | (UInt32)m_arrDigits[0] );
}
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator Int32() const {
    Int32 iRes = ( (Int32)(m_arrDigits[1] & 0x7fff) ) << 16;
    iRes |= (Int32)m_arrDigits[0];
    if ( m_arrDigits[INT_DIGIT_LAST] & 0x8000 != 0 )
        iRes |= 0x80000000;
    return iRes;
}
...
template<UInt INT_BYTES>
inline Integer<INT_BYTES>::operator Int64() const {
    Int64 iRes = ( (Int64)(m_arrDigits[3] & 0x7fff) ) << 48;
    iRes |= ( (Int64)m_arrDigits[2] ) << 32;
    iRes |= ( (Int64)m_arrDigits[1] ) << 16;
    iRes |= (Int64)m_arrDigits[0];
    if ( m_arrDigits[INT_DIGIT_LAST] & 0x8000 != 0 )
...
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Integer<INT_BYTES>::operator+=( const Integer<INT_BYTES> & rhs ) { *this = (*this) + rhs; return (*this); }
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Integer<INT_BYTES>::operator-=( const Integer<INT_BYTES> & rhs ) { *this = (*this) - rhs; return (*this); }
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Integer<INT_BYTES>::operator*=( const Integer<INT_BYTES> & rhs ) { *this = (*this) * rhs; return (*this); }
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Integer<INT_BYTES>::operator/=( const Integer<INT_BYTES> & rhs ) { *this = (*this) / rhs; return (*this); }
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Integer<INT_BYTES>::operator%=( const Integer<INT_BYTES> & rhs ) { *this = (*this) % rhs; return (*this); }

template<UInt INT_BYTES> inline Bool Integer<INT_BYTES>::operator==( const Integer<INT_BYTES> & rhs ) const { return ( _Compare(*this, rhs) == 0 ); }
template<UInt INT_BYTES> inline Bool Integer<INT_BYTES>::operator!=( const Integer<INT_BYTES> & rhs ) const { return ( _Compare(*this, rhs) != 0 ); }
template<UInt INT_BYTES> inline Bool Integer<INT_BYTES>::operator<=( const Integer<INT_BYTES> & rhs ) const { return ( _Compare(*this, rhs) <= 0 ); }
template<UInt INT_BYTES> inline Bool Integer<INT_BYTES>::operator>=( const Integer<INT_BYTES> & rhs ) const { return ( _Compare(*this, rhs) >= 0 ); }
template<UInt INT_BYTES> inline Bool Integer<INT_BYTES>::operator<( const Integer<INT_BYTES> & rhs ) const { return ( _Compare(*this, rhs) < 0 ); }
                                  ...
                                  Integer<INT_BYTES> & outQuotient, Integer<INT_BYTES> & outRemainder )
{
    ...
    // Divide
    if ( absD > Integer<INT_BYTES>(0x0000ffff) )
                                       ...
                                       Integer<INT_BYTES> & outQuotient, Integer<INT_BYTES> & outRemainder )
{
    ...
    Integer<INT_BYTES> intAdjNum = ( iNumerator * Integer<INT_BYTES>(iAdjust) );
    Integer<INT_BYTES> intAdjDenom = ( iDenominator * Integer<INT_BYTES>(iAdjust) );
