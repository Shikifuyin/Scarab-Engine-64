...
Rational<INT_BYTES>::Rational():
    m_iNumerator(0), m_iDenominator(1)
{
    // nothing to do
}
template<UInt INT_BYTES>
...
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Rational<INT_BYTES>::Numerator()               { return m_iNumerator; }
template<UInt INT_BYTES> inline Integer<INT_BYTES> & Rational<INT_BYTES>::Denominator()             { return m_iDenominator; }
template<UInt INT_BYTES> inline const Integer<INT_BYTES> & Rational<INT_BYTES>::Numerator() const   { return m_iNumerator; }
template<UInt INT_BYTES> inline const Integer<INT_BYTES> & Rational<INT_BYTES>::Denominator() const { return m_iDenominator; }
