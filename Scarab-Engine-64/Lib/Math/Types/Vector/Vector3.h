...
template<typename Real> class TVector4;

/////////////////////////////////////////////////////////////////////////////////
// The TVector3 class
template<typename Real>
class alignas(32) TVector3
{
public:
    // Constant values
	...
	// Real operations
	inline TVector3<Real> operator+( const Real & rhs ) const;
	inline TVector3<Real> operator-( const Real & rhs ) const;
	inline TVector3<Real> operator*( const Real & rhs ) const;
	inline TVector3<Real> operator/( const Real & rhs ) const;

	inline TVector3<Real> & operator+=( const Real & rhs );
	inline TVector3<Real> & operator-=( const Real & rhs );
	inline TVector3<Real> & operator*=( const Real & rhs );
	inline TVector3<Real> & operator/=( const Real & rhs );
