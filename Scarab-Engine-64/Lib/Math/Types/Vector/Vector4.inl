...
template<typename Real> TVector4<Real>::TVector4( Real x, Real y, Real z, Real w )  { X = x; Y = y; Z = z; W = w; }
...
template<typename Real> inline Real TVector4<Real>::operator[]( Int i ) const   { return *( ((const Real*)this) + i ); }
template<typename Real> inline Real & TVector4<Real>::operator[]( UInt i )      { return *( ((Real*)this) + i ); }
template<typename Real> inline Real TVector4<Real>::operator[]( UInt i ) const  { return *( ((const Real*)this) + i ); }
