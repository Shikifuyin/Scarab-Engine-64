...
DWord D2D1RenderTargetTypeToD2D1[D2D1_RENDERTARGET_COUNT] = {
...
DWord D2D1RenderTargetUsageToD2D1[D2D1_RENDERTARGETUSAGE_COUNT] = {
...
DWord D2D1BitmapAlphaModeToD2D1[D2D1BITMAP_ALPHAMODE_COUNT] = {
...
Void D2D1RenderTargetDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_RENDER_TARGET_PROPERTIES * pDesc = (const D2D1_RENDER_TARGET_PROPERTIES *)pD2D1Desc;
...
Void D2D1RenderTargetDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_RENDER_TARGET_PROPERTIES * outDesc = (D2D1_RENDER_TARGET_PROPERTIES*)outD2D1Desc;

    outDesc->type = (D2D1_RENDER_TARGET_TYPE)( D2D1RenderTargetTypeToD2D1[iType] );
    outDesc->usage = (D2D1_RENDER_TARGET_USAGE)( D2D1RenderTargetUsageToD2D1[iUsage] );
    outDesc->pixelFormat.format = (DXGI_FORMAT)( PixelFormatToDXGI[iFormat] );
    outDesc->pixelFormat.alphaMode = (D2D1_ALPHA_MODE)( D2D1BitmapAlphaModeToD2D1[iAlphaMode] );
    outDesc->dpiX = fDpiX;
    outDesc->dpiY = fDpiY;
...
DWord D2D1TextDrawOptionsToD2D1[D2D1TEXT_DRAWOPTION_COUNT] = {
...
DWord D2D1AntialiasingModeToD2D1[D2D1_ANTIALIASING_COUNT] = {
...
DWord D2D1TextAntialiasingModeToD2D1[D2D1TEXT_ANTIALIASING_COUNT] = {
...
Void D2D1RenderStateDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_DRAWING_STATE_DESCRIPTION * pDesc = (const D2D1_DRAWING_STATE_DESCRIPTION *)pD2D1Desc;
...
Void D2D1RenderStateDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_DRAWING_STATE_DESCRIPTION * outDesc = (D2D1_DRAWING_STATE_DESCRIPTION*)outD2D1Desc;

    outDesc->antialiasMode = (D2D1_ANTIALIAS_MODE)( D2D1AntialiasingModeToD2D1[iAntialiasingMode] );
    outDesc->textAntialiasMode = (D2D1_TEXT_ANTIALIAS_MODE)( D2D1TextAntialiasingModeToD2D1[iTextAntialiasingMode] );
...
DWord D2D1TextPixelGeometryToD2D1[D2D1TEXT_PIXELGEOMETRY_COUNT] = {
...
DWord D2D1TextRenderingModeToD2D1[D2D1TEXT_RENDERINGMODE_COUNT] = {
...
DWord D2D1StrokeCapStyleToD2D1[D2D1STROKE_CAPSTYLE_COUNT] = {
    D2D1_CAP_STYLE_FLAT,
...
DWord D2D1StrokeLineJoinToD2D1[D2D1STROKE_LINEJOIN_COUNT] = {
...
DWord D2D1StrokeDashStyleToD2D1[D2D1STROKE_DASHSTYLE_COUNT] = {
...
Void D2D1StrokeStyleDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_STROKE_STYLE_PROPERTIES * pDesc = (const D2D1_STROKE_STYLE_PROPERTIES *)pD2D1Desc;
...
Void D2D1StrokeStyleDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_STROKE_STYLE_PROPERTIES * outDesc = (D2D1_STROKE_STYLE_PROPERTIES*)outD2D1Desc;

    outDesc->startCap = (D2D1_CAP_STYLE)( D2D1StrokeCapStyleToD2D1[iStartCap] );
    outDesc->endCap = (D2D1_CAP_STYLE)( D2D1StrokeCapStyleToD2D1[iEndCap] );
    outDesc->dashCap = (D2D1_CAP_STYLE)( D2D1StrokeCapStyleToD2D1[iDashCap] );
    outDesc->lineJoin = (D2D1_LINE_JOIN)( D2D1StrokeLineJoinToD2D1[iLineJoin] );
    outDesc->miterLimit = fMiterLimit;
    outDesc->dashStyle = (D2D1_DASH_STYLE)( D2D1StrokeDashStyleToD2D1[iDashStyle] );
...
DWord D2D1BitmapInterpolationModeToD2D1[D2D1BITMAP_INTERPOLATION_COUNT] = {
...
DWord D2D1BitmapOpacityMaskContentToD2D1[D2D1BITMAP_OPACITYMASK_COUNT] = {
...
DWord D2D1BrushGammaToD2D1[D2D1BRUSH_GAMMA_COUNT] = {
    D2D1_GAMMA_2_2,
    D2D1_GAMMA_1_0
};
...
DWord D2D1BrushWrapModeToD2D1[D2D1BRUSH_WRAPMODE_COUNT] = {
    D2D1_EXTEND_MODE_CLAMP,
    D2D1_EXTEND_MODE_WRAP,
    D2D1_EXTEND_MODE_MIRROR
};

Void D2D1BrushDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_BRUSH_PROPERTIES * pDesc = (const D2D1_BRUSH_PROPERTIES *)pD2D1Desc;
...
Void D2D1BrushDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_BRUSH_PROPERTIES * outDesc = (D2D1_BRUSH_PROPERTIES*)outD2D1Desc;
...
Void D2D1BrushLinearGradientDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES * pDesc = (const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *)pD2D1Desc;
...
Void D2D1BrushLinearGradientDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES * outDesc = (D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES*)outD2D1Desc;
...
Void D2D1BrushRadialGradientDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES * pDesc = (const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *)pD2D1Desc;
...
Void D2D1BrushRadialGradientDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES * outDesc = (D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES*)outD2D1Desc;
...
Void D2D1BrushBitmapDesc::ConvertFrom( const Void * pD2D1Desc )
{
    const D2D1_BITMAP_BRUSH_PROPERTIES * pDesc = (const D2D1_BITMAP_BRUSH_PROPERTIES *)pD2D1Desc;
...
Void D2D1BrushBitmapDesc::ConvertTo( Void * outD2D1Desc ) const
{
    D2D1_BITMAP_BRUSH_PROPERTIES * outDesc = (D2D1_BITMAP_BRUSH_PROPERTIES*)outD2D1Desc;

    outDesc->interpolationMode = (D2D1_BITMAP_INTERPOLATION_MODE)( D2D1BitmapInterpolationModeToD2D1[iInterpolationMode] );
    outDesc->extendModeX = (D2D1_EXTEND_MODE)( D2D1BrushWrapModeToD2D1[iWrapModeX] );
    outDesc->extendModeY = (D2D1_EXTEND_MODE)( D2D1BrushWrapModeToD2D1[iWrapModeY] );
}
...
DWord D2D1GeometryRelationToD2D1[D2D1GEOMETRY_RELATION_COUNT] = {
...
DWord D2D1GeometryCombineModeToD2D1[D2D1GEOMETRY_COMBINE_COUNT] = {
...
DWord D2D1GeometrySimplifyOptionToD2D1[D2D1GEOMETRY_SIMPLIFY_COUNT] = {
...
DWord D2D1GeometryFillModeToD2D1[D2D1GEOMETRY_FILL_COUNT] = {
...
DWord D2D1GeometrySegmentFlagToD2D1[D2D1GEOMETRY_SEGMENT_COUNT] = {
...
DWord D2D1LayerOptionsToD2D1[D2D1LAYER_OPTION_COUNT] = {
...
DWord D2D1FontWeightToD2D1[D2D1FONT_WEIGHT_COUNT] = {
...
DWord D2D1FontStyleToD2D1[D2D1FONT_STYLE_COUNT] = {
...
DWord D2D1FontStretchToD2D1[D2D1FONT_STRETCH_COUNT] = {
...
DWord D2D1FontInfoStringIDToD2D1[D2D1FONT_INFOSTRING_COUNT] = {
...
DWord D2D1FontSimulationToD2D1[D2D1FONT_SIMULATION_COUNT] = {
    DWRITE_FONT_SIMULATIONS_NONE,
    DWRITE_FONT_SIMULATIONS_BOLD,
    DWRITE_FONT_SIMULATIONS_OBLIQUE
};

Void D2D1FontMetrics::ConvertFrom( const Void * pD2D1Desc )
{
    const DWRITE_FONT_METRICS * pDesc = (const DWRITE_FONT_METRICS *)pD2D1Desc;
...
DWord D2D1FontFaceTypeToD2D1[D2D1FONT_FACE_COUNT] = {
...
DWord D2D1TextMeasuringModeToD2D1[D2D1TEXT_MEASURING_COUNT] = {
    DWRITE_MEASURING_MODE_NATURAL,
    DWRITE_MEASURING_MODE_GDI_CLASSIC,
    DWRITE_MEASURING_MODE_GDI_NATURAL
};

Void D2D1FontGlyphMetrics::ConvertFrom( const Void * pD2D1Desc )
{
    const DWRITE_GLYPH_METRICS * pDesc = (const DWRITE_GLYPH_METRICS *)pD2D1Desc;
...
DWord D2D1TextFlowDirectionToD2D1[D2D1TEXT_FLOWDIRECTION_COUNT] = {
...
DWord D2D1TextReadingDirectionToD2D1[D2D1TEXT_READINGDIRECTION_COUNT] = {
...
DWord D2D1TextLineSpacingMethodToD2D1[D2D1TEXT_LINESPACING_COUNT] = {
...
DWord D2D1TextAlignmentToD2D1[D2D1TEXT_ALIGNMENT_COUNT] = {
...
DWord D2D1TextParagraphAlignmentToD2D1[D2D1TEXT_PARAGRAPHALIGNMENT_COUNT] = {
...
DWord D2D1TextTrimmingGranularityToD2D1[D2D1TEXT_TRIMMINGGRANULARITY_COUNT] = {
...
DWord D2D1TextWordWrappingToD2D1[D2D1TEXT_WORDWRAPPING_COUNT] = {
...
DWord D2D1TextBreakConditionToD2D1[D2D1TEXT_BREAKCONDITION_COUNT] = {
...
Void D2D1TextInlineObjectMetrics::ConvertFrom( const Void * pD2D1Desc )
{
    const DWRITE_INLINE_OBJECT_METRICS * pDesc = (const DWRITE_INLINE_OBJECT_METRICS *)pD2D1Desc;
...
Void D2D1TextInlineObjectMetrics::ConvertTo( Void * outD2D1Desc )
{
    DWRITE_INLINE_OBJECT_METRICS * outDesc = (DWRITE_INLINE_OBJECT_METRICS*)outD2D1Desc;
...
Void D2D1TextOverhangMetrics::ConvertFrom( const Void * pD2D1Desc )
{
    const DWRITE_OVERHANG_METRICS * pDesc = (const DWRITE_OVERHANG_METRICS *)pD2D1Desc;
...
Void D2D1TextOverhangMetrics::ConvertTo( Void * outD2D1Desc )
{
    DWRITE_OVERHANG_METRICS * outDesc = (DWRITE_OVERHANG_METRICS*)outD2D1Desc;
...
Void D2D1TextMetrics::ConvertFrom( const Void * pD2D1Desc )
{
    const DWRITE_TEXT_METRICS * pDesc = (const DWRITE_TEXT_METRICS *)pD2D1Desc;
