...
protected:
    Void * m_pRoundedRectangleGeometry;
};
...
protected:
    ...
    Void * m_pPathGeometry;

    Bool m_bOpened;
    Bool m_bFigureInProgress;
    Void * m_pGeometrySink;
};
