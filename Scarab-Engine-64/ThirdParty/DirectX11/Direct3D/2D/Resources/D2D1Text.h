...
public:
    ...
    Void GetGdiCompatibleGlyphMetrics( D2D1FontGlyphMetrics * outGlyphMetrics, const UShort * arrGlyphIndices, UInt iGlyphCount, Bool bIsSideways,
                                       Float fSizeDIP, Float fPixelsPerDIP, Bool bUseGdiNatural, const D2D1Matrix32 * pTransform = NULL ) const;
