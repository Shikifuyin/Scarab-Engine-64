...
extern DWord PixelFormatToDXGI[PIXEL_FMT_COUNT];
...
extern DWord D3D11OutputRotationToDXGI[D3D11OUTPUT_ROTATION_COUNT];
...
extern DWord D3D11DisplayModeScanlineOrderingToDXGI[D3D11DISPLAYMODE_SCANLINE_COUNT];
...
extern DWord D3D11DisplayModeScalingToDXGI[D3D11DISPLAYMODE_SCALING_COUNT];

typedef struct _d3d11_adapter_desc {
    Void ConvertFrom( const Void * pDXGIDesc, UInt iAdapter );
    Void ConvertTo( Void * outDXGIDesc, UInt * outAdapter ) const;
    ...
    UInt64 iDedicatedVideoMemory;
    UInt64 iDedicatedSystemMemory;
    UInt64 iSharedSystemMemory;
} D3D11AdapterDesc;

typedef struct _d3d11_output_desc {
    Void ConvertFrom( const Void * pDXGIDesc, UInt iOutput );
    Void ConvertTo( Void * outDXGIDesc, UInt * outOutput ) const;
...
typedef struct _d3d11_displaymode_desc {
    Void ConvertFrom( const Void * pDXGIDesc, UInt iDisplayMode );
    Void ConvertTo( Void * outDXGIDesc, UInt * outDisplayMode ) const;
...
typedef struct _d3d11_gamma_caps {
    Void ConvertFrom( const Void * pDXGIDesc );
    Void ConvertTo( Void * outDXGIDesc ) const;
...
extern DWord D3D11InputFieldSlotClassToD3D11[D3D11INPUTFIELD_SLOTCLASS_COUNT];
...
extern DWord D3D11SamplerWrapModeToD3D11[D3D11SAMPLER_WRAP_COUNT];
...
extern DWord D3D11SamplerCompareFunctionToD3D11[D3D11SAMPLER_COMPARE_COUNT];
...
extern DWord D3D11RasterizerFillModeToD3D11[D3D11RASTERIZER_FILL_COUNT];
...
extern DWord D3D11RasterizerCullModeToD3D11[D3D11RASTERIZER_CULL_COUNT];
...
extern DWord D3D11DepthWriteMaskToD3D11[D3D11DEPTH_WRITEMASK_COUNT];
...
extern DWord D3D11StencilOperationToD3D11[D3D11STENCIL_OP_COUNT];
...
extern DWord D3D11DepthStencilCompareFunctionToD3D11[D3D11DEPTHSTENCIL_COMPARE_COUNT];
...
extern DWord D3D11BlendParameterToD3D11[D3D11BLEND_PARAM_COUNT];
...
extern DWord D3D11BlendOperationToD3D11[D3D11BLEND_OP_COUNT];
...
typedef struct _d3d11_blendstate_desc {
    ...
    struct _d3d11_blendstate_rendertarget_desc {
        Bool bBlendEnabled;
...
extern DWord D3D11QueryTypeToD3D11[D3D11QUERY_COUNT];
...
extern DWord D3D11PredicateTypeToD3D11[D3D11PREDICATE_COUNT];
...
extern DWord D3D11CounterTypeToD3D11[D3D11COUNTER_COUNT];
...
extern DWord D3D11ResourceUsageToD3D11[D3D11RESOURCE_USAGE_COUNT];
...
extern DWord D3D11ResourceDimensionToD3D11[D3D11RESOURCE_DIMENSION_COUNT];
...
extern DWord D3D11ResourceLockToD3D11[D3D11RESOURCE_LOCK_COUNT];
...
extern DWord D3D11TextureCubeFaceToD3D11[D3D11TEXTURE_CUBEFACE_COUNT];
...
extern DWord D3D11RenderTargetViewDimensionToD3D11[D3D11RENDERTARGETVIEW_DIM_COUNT];
...
extern DWord D3D11DepthStencilViewDimensionToD3D11[D3D11DEPTHSTENCILVIEW_DIM_COUNT];
...
typedef struct _d3d11_depthstencil_view_desc {
    ...
    PixelFormat iFormat;
    DWord iFlags; // D3D11DepthStencilViewFlags
...
extern DWord D3D11ShaderViewDimensionToD3D11[D3D11SHADERVIEW_DIM_COUNT];
...
typedef struct _d3d11_shader_view_desc {
    ...
    union {
        struct { UInt iOffset; UInt iSize; } hBuffer;
        struct { UInt iOffset; UInt iSize; DWord iFlags; } hBufferEx; // D3D11ShaderViewBufferExFlags
...
extern DWord D3D11UnorderedAccessViewDimensionToD3D11[D3D11UNORDEREDACCESSVIEW_DIM_COUNT];
...
typedef struct _d3d11_unorderedaccess_view_desc {
    ...
    union {
        struct { UInt iOffset; UInt iSize; DWord iFlags; } hBuffer; // D3D11UnorderedAccessViewBufferFlags
        struct { UInt iMipSlice; } hTexture1D;
        struct { UInt iMipSlice; UInt iArraySlice; UInt iArraySliceCount; } hTexture1DArray;
        struct { UInt iMipSlice; } hTexture2D;
        struct { UInt iMipSlice; UInt iArraySlice; UInt iArraySliceCount; } hTexture2DArray;
...
extern DWord D3D11ShaderPrimitiveToD3D11[D3D11SHADER_PRIMITIVE_COUNT];
...
extern DWord D3D11ShaderPrimitiveTopologyToD3D11[D3D11SHADER_PRIMITIVETOPOLOGY_COUNT];
...
extern DWord D3D11ShaderTesselatorOutputToD3D11[D3D11SHADER_TESSELLATOROUTPUT_COUNT];
...
extern DWord D3D11ShaderTesselatorPartitioningToD3D11[D3D11SHADER_TESSELLATORPARTITIONING_COUNT];
...
extern DWord D3D11ShaderTesselatorDomainToD3D11[D3D11SHADER_TESSELLATORDOMAIN_COUNT];

typedef struct _d3d11_shader_desc {
    Void ConvertFrom( const Void * pD3D11Desc, Bool bD3D11IsSampleFrequencyShader, UInt iD3D11RequirementFlags,
...
extern DWord D3D11ShaderParameterTypeToD3D11[D3D11SHADER_PARAMETER_COUNT];
...
extern DWord D3D11ShaderRegisterComponentTypeToD3D11[D3D11SHADER_REGISTERCOMPONENT_COUNT];
...
extern DWord D3D11ShaderMinPrecisionToD3D11[D3D11SHADER_MINPRECISION_COUNT];
...
extern DWord D3D11ShaderInputTypeToD3D11[D3D11SHADER_INPUT_COUNT];
...
extern DWord D3D11ShaderReturnTypeToD3D11[D3D11SHADER_RETURN_COUNT];
...
extern DWord D3D11ShaderConstantBufferTypeToD3D11[D3D11SHADER_CONSTANTBUFFER_COUNT];
...
extern DWord D3D11ShaderVariableClassToD3D11[D3D11SHADER_VARIABLECLASS_COUNT];
...
extern DWord D3D11ShaderVariableTypeToD3D11[D3D11SHADER_VARIABLE_COUNT];

typedef struct _d3d11_shader_type_desc {
    Void ConvertFrom( const Void * pD3D11Desc, UInt iD3D11InterfaceCount );
