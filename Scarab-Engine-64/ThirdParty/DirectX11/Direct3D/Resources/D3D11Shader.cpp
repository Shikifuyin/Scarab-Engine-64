...
Void D3D11ShaderCompiler::Compile( const AChar * strHLSLCode, UInt iHLSLCodeLength, const D3D11ShaderCompilationData * pCompilationData )
{
    ...
    HRESULT hRes = D3DCompile2( strHLSLCode, iHLSLCodeLength, pCompilationData->strName, (const D3D_SHADER_MACRO *)( pCompilationData->arrMacros ), D3D_COMPILE_STANDARD_FILE_INCLUDE,
                                ...
                                0, NULL, 0, (ID3DBlob**)&m_pByteCode, &pErrors );
    DebugAssert( hRes == S_OK && m_pByteCode != NULL );

    if ( pErrors != NULL ) {
        // Lookup errors here ...
        AChar strErrorBuffer[4096];
        UInt64 iSize = pErrors->GetBufferSize();
...
const Byte * D3D11ShaderCompiler::GetByteCode() const
{
    ...
    return (const Byte *)( ((ID3DBlob*)m_pByteCode)->GetBufferPointer() );
}
UInt64 D3D11ShaderCompiler::GetByteCodeLength() const
{
    DebugAssert( IsCompiled() );

    return ((ID3DBlob*)m_pByteCode)->GetBufferSize();
}
...
Void D3D11ShaderReflectConstantBuffer::GetDesc( D3D11ShaderConstantBufferDesc * outDesc ) const
{
    ...
    HRESULT hRes = ((ID3D11ShaderReflectionConstantBuffer*)m_pConstantBuffer)->GetDesc( &hDescCB );
...
Void D3D11ShaderReflectConstantBuffer::GetVariable( D3D11ShaderReflectVariable * outVariable, UInt iIndex ) const
{
    ...
    ID3D11ShaderReflectionVariable * pVariable = ((ID3D11ShaderReflectionConstantBuffer*)m_pConstantBuffer)->GetVariableByIndex( iIndex );
...
Void D3D11ShaderReflectConstantBuffer::GetVariable( D3D11ShaderReflectVariable * outVariable, const AChar * strName ) const
{
    ...
    ID3D11ShaderReflectionVariable * pVariable = ((ID3D11ShaderReflectionConstantBuffer*)m_pConstantBuffer)->GetVariableByName( strName );
    DebugAssert( pVariable != NULL );
...
Void D3D11ShaderReflectVariable::GetDesc( D3D11ShaderVariableDesc * outDesc ) const
{
    ...
    HRESULT hRes = ((ID3D11ShaderReflectionVariable*)m_pVariable)->GetDesc( &hDescVar );
    DebugAssert( hRes == S_OK );
...
UInt D3D11ShaderReflectVariable::GetInterfaceSlot( UInt iArrayIndex ) const
{
    ...
    return ((ID3D11ShaderReflectionVariable*)m_pVariable)->GetInterfaceSlot( iArrayIndex );
}
...
Void D3D11ShaderReflectVariable::GetConstantBuffer( D3D11ShaderReflectConstantBuffer * outConstantBuffer ) const
{
    ...
    ID3D11ShaderReflectionConstantBuffer * pConstantBuffer = ((ID3D11ShaderReflectionVariable*)m_pVariable)->GetBuffer();
...
Void D3D11ShaderReflectVariable::GetType( D3D11ShaderReflectType * outType ) const
{
    ...
    ID3D11ShaderReflectionType * pType = ((ID3D11ShaderReflectionVariable*)m_pVariable)->GetType();
...
Void D3D11ShaderReflectType::GetDesc( D3D11ShaderTypeDesc * outDesc ) const
{
    ...
    HRESULT hRes = ((ID3D11ShaderReflectionType*)m_pType)->GetDesc( &hDescType );
    DebugAssert( hRes == S_OK );

    outDesc->ConvertFrom( &hDescType, ((ID3D11ShaderReflectionType*)m_pType)->GetNumInterfaces() );
}
...
Bool D3D11ShaderReflectType::IsEqual( const D3D11ShaderReflectType * pType ) const
{
    ...
    return ( ((ID3D11ShaderReflectionType*)m_pType)->IsEqual( (ID3D11ShaderReflectionType*)(pType->m_pType) ) == S_OK );
}
Bool D3D11ShaderReflectType::InheritsFrom( const D3D11ShaderReflectType * pBaseType ) const
{
    ...
    return ( ((ID3D11ShaderReflectionType*)m_pType)->IsOfType( (ID3D11ShaderReflectionType*)(pBaseType->m_pType) ) == S_OK );
}
Bool D3D11ShaderReflectType::ImplementsInterface( const D3D11ShaderReflectType * pInterface ) const
{
    ...
    return ( ((ID3D11ShaderReflectionType*)m_pType)->ImplementsInterface( (ID3D11ShaderReflectionType*)(pInterface->m_pType) ) == S_OK );
}
...
Void D3D11ShaderReflectType::GetBaseClass( D3D11ShaderReflectType * outBaseClass ) const
{
    ...
    ID3D11ShaderReflectionType * pType = ((ID3D11ShaderReflectionType*)m_pType)->GetSubType();
    DebugAssert( pType != NULL );
...
Void D3D11ShaderReflectType::GetVariableBaseClass( D3D11ShaderReflectType * outBaseClass ) const
{
    ...
    ID3D11ShaderReflectionType * pType = ((ID3D11ShaderReflectionType*)m_pType)->GetBaseClass();
    DebugAssert( pType != NULL );
...
UInt D3D11ShaderReflectType::GetInterfaceCount() const
{
    ...
    return ((ID3D11ShaderReflectionType*)m_pType)->GetNumInterfaces();
}
Void D3D11ShaderReflectType::GetInterface( D3D11ShaderReflectType * outInterface, UInt iIndex ) const
{
    DebugAssert( m_pType != NULL );

    ID3D11ShaderReflectionType * pType = ((ID3D11ShaderReflectionType*)m_pType)->GetInterfaceByIndex( iIndex );
    DebugAssert( pType != NULL );
...
const AChar * D3D11ShaderReflectType::GetMemberTypeName( UInt iIndex ) const
{
    ...
    return ((ID3D11ShaderReflectionType*)m_pType)->GetMemberTypeName( iIndex );
}
Void D3D11ShaderReflectType::GetMemberType( D3D11ShaderReflectType * outMember, UInt iIndex ) const
{
    DebugAssert( m_pType != NULL );

    ID3D11ShaderReflectionType * pType = ((ID3D11ShaderReflectionType*)m_pType)->GetMemberTypeByIndex( iIndex );
    DebugAssert( pType != NULL );
...
Void D3D11ShaderReflectType::GetMemberType( D3D11ShaderReflectType * outMember, const AChar * strName ) const
{
    ...
    ID3D11ShaderReflectionType * pType = ((ID3D11ShaderReflectionType*)m_pType)->GetMemberTypeByName( strName );
    DebugAssert( pType != NULL );
...
Void D3D11Shader::GetDesc( D3D11ShaderDesc * outDesc ) const
{
    ...
    ID3D11ShaderReflection * pReflector = (ID3D11ShaderReflection*)m_pReflector;

    D3D11_SHADER_DESC hDesc;
    HRESULT hRes = pReflector->GetDesc( &hDesc );
    DebugAssert( hRes == S_OK );

    outDesc->ConvertFrom( &hDesc, ( pReflector->IsSampleFrequencyShader() == TRUE ), (UInt)( pReflector->GetRequiresFlags() ), pReflector->GetNumInterfaceSlots(),
                          pReflector->GetBitwiseInstructionCount(), pReflector->GetConversionInstructionCount(), pReflector->GetMovInstructionCount(),
                          pReflector->GetMovcInstructionCount() );
}
...
UInt D3D11Shader::GetInputParameterCount() const
{
    ...
    D3D11_SHADER_DESC hDesc;
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetDesc( &hDesc );
    DebugAssert( hRes == S_OK );
...
Void D3D11Shader::GetInputParameterDesc( D3D11ShaderParameterDesc * outInputParameterDesc, UInt iIndex ) const
{
    ...
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetInputParameterDesc( iIndex, &hDesc );
    DebugAssert( hRes == S_OK );
...
Void D3D11Shader::GetOutputParameterDesc( D3D11ShaderParameterDesc * outOutputParameterDesc, UInt iIndex ) const
{
    ...
    D3D11_SIGNATURE_PARAMETER_DESC hDesc;
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetOutputParameterDesc( iIndex, &hDesc );
    DebugAssert( hRes == S_OK );
...
Void D3D11Shader::GetPatchConstantParameterDesc( D3D11ShaderParameterDesc * outPatchConstantParameterDesc, UInt iIndex ) const
{
    ...
    D3D11_SIGNATURE_PARAMETER_DESC hDesc;
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetPatchConstantParameterDesc( iIndex, &hDesc );
    DebugAssert( hRes == S_OK );
...
Void D3D11Shader::GetBindingDesc( D3D11ShaderBindingDesc * outBindingDesc, UInt iIndex ) const
{
    ...
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetResourceBindingDesc( iIndex, &hDesc );
    DebugAssert( hRes == S_OK );
...
Void D3D11Shader::GetBindingDesc( D3D11ShaderBindingDesc * outBindingDesc, const AChar * strName ) const
{
    ...
    D3D11_SHADER_INPUT_BIND_DESC hDesc;
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetResourceBindingDescByName( strName, &hDesc );
    DebugAssert( hRes == S_OK );
...
Void D3D11Shader::GetConstantBuffer( D3D11ShaderReflectConstantBuffer * outConstantBuffer, UInt iIndex ) const
{
    ...
    ID3D11ShaderReflectionConstantBuffer * pConstantBuffer = ((ID3D11ShaderReflection*)m_pReflector)->GetConstantBufferByIndex( iIndex );
    DebugAssert( pConstantBuffer != NULL );
...
Void D3D11Shader::GetConstantBuffer( D3D11ShaderReflectConstantBuffer * outConstantBuffer, const AChar * strName ) const
{
    ...
    ID3D11ShaderReflectionConstantBuffer * pConstantBuffer = ((ID3D11ShaderReflection*)m_pReflector)->GetConstantBufferByName( strName );
    DebugAssert( pConstantBuffer != NULL );
...
Void D3D11Shader::GetVariable( D3D11ShaderReflectVariable * outVariable, const AChar * strName ) const
{
    ...
    ID3D11ShaderReflectionVariable * pVariable = ((ID3D11ShaderReflection*)m_pReflector)->GetVariableByName( strName );
    DebugAssert( pVariable != NULL );
...
UInt D3D11Shader::GetInterfaceSlotCount() const
{
    ...
    return ((ID3D11ShaderReflection*)m_pReflector)->GetNumInterfaceSlots();
}
...
Void D3D11Shader::GetThreadGroupSize( UInt * outSizeX, UInt * outSizeY, UInt * outSizeZ ) const
{
    ...
    HRESULT hRes = ((ID3D11ShaderReflection*)m_pReflector)->GetThreadGroupSize( outSizeX, outSizeY, outSizeZ );
    DebugAssert( hRes == S_OK );
}
...
Void D3D11Shader::AddDynamicLink( const AChar * strInterfaceInstance, const AChar * strClassInstance )
{
    ...
    HRESULT hRes = ((ID3D11ClassLinkage*)m_pClassLinkage)->GetClassInstance( strClassInstance, 0, &pClassInstance );
    DebugAssert( hRes == S_OK );
...
{
    m_pReflector = NULL;
    HRESULT hRes = D3DReflect( m_pCompiledShader->GetByteCode(), m_pCompiledShader->GetByteCodeLength(), IID_ID3D11ShaderReflection, &m_pReflector );
...
{
    ((ID3D11ShaderReflection*)m_pReflector)->Release();
    m_pReflector = NULL;
}

Void D3D11Shader::_InitializeDynamicLinkage()
{
    m_iClassInstanceCount = ((ID3D11ShaderReflection*)m_pReflector)->GetNumInterfaceSlots();
    m_arrClassInstances = (Void**)( SystemFn->MemAlloc(m_iClassInstanceCount * sizeof(ID3D11ClassInstance*)) );
...
Void D3D11VertexShader::_NakedCreate()
{
    ...
    m_pShader = NULL;
    hRes = ((ID3D11VertexShader*)m_pVertexShader)->QueryInterface( __uuidof(ID3D11DeviceChild), &m_pShader );
...
Void D3D11VertexShader::_NakedDestroy()
{
    ...
    ((ID3D11DeviceChild*)m_pShader)->Release();
    m_pShader = NULL;

    ((ID3D11VertexShader*)m_pVertexShader)->Release();
    m_pVertexShader = NULL;

    if ( m_bHasDynamicLinkage ) {
        ((ID3D11ClassLinkage*)m_pClassLinkage)->Release();
        m_pClassLinkage = NULL;
    }
}
...
Void D3D11GeometryShader::PushSODeclaration( const D3D11StreamOutputDeclaration * pSODeclaration )
{
    ...
    MemCopy( m_arrSODeclarations + m_iSODeclarationCount, pSODeclaration, sizeof(D3D11StreamOutputDeclaration) );
...
Void D3D11GeometryShader::_NakedCreate()
{
    ...
    if ( m_iSODeclarationCount > 0 ) {
        D3D11_SO_DECLARATION_ENTRY arrTemp[D3D11RENDERER_MAX_STREAMOUTPUT_DECLARATIONS];
        for ( UInt i = 0; i < m_iSODeclarationCount; ++i )
    ...
    m_pShader = NULL;
    hRes = ((ID3D11GeometryShader*)m_pGeometryShader)->QueryInterface( __uuidof(ID3D11DeviceChild), &m_pShader );
    DebugAssert( hRes == S_OK && m_pShader != NULL );
...
Void D3D11GeometryShader::_NakedDestroy()
{
    ...
    ((ID3D11GeometryShader*)m_pGeometryShader)->Release();
    m_pGeometryShader = NULL;
...
Void D3D11PixelShader::_NakedCreate()
{
    ...
    m_pShader = NULL;
    hRes = ((ID3D11PixelShader*)m_pPixelShader)->QueryInterface( __uuidof(ID3D11DeviceChild), &m_pShader );
    DebugAssert( hRes == S_OK && m_pShader != NULL );
...
Void D3D11PixelShader::_NakedDestroy()
{
    ...
    ((ID3D11PixelShader*)m_pPixelShader)->Release();
    m_pPixelShader = NULL;
...
Void D3D11HullShader::_NakedCreate()
{
    ...
    m_pShader = NULL;
    hRes = ((ID3D11HullShader*)m_pHullShader)->QueryInterface( __uuidof(ID3D11DeviceChild), &m_pShader );
    DebugAssert( hRes == S_OK && m_pShader != NULL );
...
Void D3D11HullShader::_NakedDestroy()
{
    ...
    ((ID3D11HullShader*)m_pHullShader)->Release();
    m_pHullShader = NULL;
...
Void D3D11DomainShader::_NakedCreate()
{
    ...
    m_pShader = NULL;
    hRes = ((ID3D11DomainShader*)m_pDomainShader)->QueryInterface( __uuidof(ID3D11DeviceChild), &m_pShader );
    DebugAssert( hRes == S_OK && m_pShader != NULL );
...
Void D3D11DomainShader::_NakedDestroy()
{
    ...
    ((ID3D11DomainShader*)m_pDomainShader)->Release();
    m_pDomainShader = NULL;
...
Void D3D11ComputeShader::_NakedCreate()
{
    ...
    m_pShader = NULL;
    hRes = ((ID3D11ComputeShader*)m_pComputeShader)->QueryInterface( __uuidof(ID3D11DeviceChild), &m_pShader );
    DebugAssert( hRes == S_OK && m_pShader != NULL );
...
Void D3D11ComputeShader::_NakedDestroy()
{
    ...
    ((ID3D11ComputeShader*)m_pComputeShader)->Release();
    m_pComputeShader = NULL;
