...
public:
    ...
    UInt64 GetByteCodeLength() const;
...
protected:
    ...
    Void * m_pClassLinkage;
    UInt m_iClassInstanceCount;
    Void ** m_arrClassInstances;
...
public:
    ...
    inline const D3D11StreamOutputDeclaration * GetSODeclaration( UInt iSODeclaration ) const;
...
protected:
    ...
    D3D11StreamOutputDeclaration m_arrSODeclarations[D3D11RENDERER_MAX_STREAMOUTPUT_DECLARATIONS];
