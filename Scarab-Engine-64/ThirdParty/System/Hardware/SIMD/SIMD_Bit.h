...
namespace SIMD { namespace Bit {
    ...
    namespace Shift16 {
        ...
        inline __m128i Left( __m128i mDst, Int iCount );     // SSE2
        inline __m128i Left( __m128i mDst, __m128i mCount ); // SSE2

        inline __m256i Left( __m256i mDst, Int iCount );     // AVX2
        inline __m256i Left( __m256i mDst, __m128i mCount ); // AVX2

        inline __m128i Right( __m128i mDst, Int iCount );     // SSE2
        inline __m128i Right( __m128i mDst, __m128i mCount ); // SSE2

        inline __m256i Right( __m256i mDst, Int iCount );     // AVX2
        inline __m256i Right( __m256i mDst, __m128i mCount ); // AVX2

        // Sign-Extend versions
        inline __m128i RightSE( __m128i mDst, Int iCount );     // SSE2
        inline __m128i RightSE( __m128i mDst, __m128i mCount ); // SSE2

        inline __m256i RightSE( __m256i mDst, Int iCount );     // AVX2
        inline __m256i RightSE( __m256i mDst, __m128i mCount ); // AVX2
    ...
    namespace Shift32 {
        ...
        // Vector versions
        inline __m128i LeftV( __m128i mDst, __m128i mCounts ); // AVX2
        inline __m256i LeftV( __m256i mDst, __m256i mCounts ); // AVX2

        inline __m128i RightV( __m128i mDst, __m128i mCounts ); // AVX2
        inline __m256i RightV( __m256i mDst, __m256i mCounts ); // AVX2
        ...
        inline __m128i RightVSE( __m128i mDst, __m128i mCounts ); // AVX2
        inline __m256i RightVSE( __m256i mDst, __m256i mCounts ); // AVX2
    };
