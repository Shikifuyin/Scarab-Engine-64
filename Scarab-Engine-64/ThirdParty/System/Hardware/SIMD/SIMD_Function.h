...
namespace SIMD { namespace Function {
	...
	// Invert
    inline __m128 InvertOne( __m128 mValue ); // SSE
    ...
    // Square Root
    inline __m128 SqrtOne( __m128 mValue );   // SSE
    inline __m128d SqrtOne( __m128d mValue ); // SSE2
    ...
    // Inverted SquareRoot
    inline __m128 InvSqrtOne( __m128 mValue ); // SSE
