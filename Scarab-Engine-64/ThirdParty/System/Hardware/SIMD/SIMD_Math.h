...
namespace SIMD { namespace Math {
    ...
    // Floor
    inline __m128 FloorOne( __m128 mDst, __m128 mSrc );    // SSE41
    inline __m128d FloorOne( __m128d mDst, __m128d mSrc ); // SSE41
    ...
    // Ceil
    inline __m128 CeilOne( __m128 mDst, __m128 mSrc );    // SSE41
    inline __m128d CeilOne( __m128d mDst, __m128d mSrc ); // SSE41
    ...
    // Round (Nearest)
    inline __m128 RoundOne( __m128 mDst, __m128 mSrc );    // SSE41
    inline __m128d RoundOne( __m128d mDst, __m128d mSrc ); // SSE41
    ...
    // Addition
    inline __m128 AddOne( __m128 mDst, __m128 mSrc );    // SSE
    inline __m128d AddOne( __m128d mDst, __m128d mSrc ); // SSE2
    ...
    // Substraction
    inline __m128 SubOne( __m128 mDst, __m128 mSrc );    // SSE
    inline __m128d SubOne( __m128d mDst, __m128d mSrc ); // SSE2
    ...
    // Multiplication
    inline __m128 MulOne( __m128 mDst, __m128 mSrc );    // SSE
    inline __m128d MulOne( __m128d mDst, __m128d mSrc ); // SSE2
    ...
    // Division
    inline __m128 DivOne( __m128 mDst, __m128 mSrc );    // SSE
    inline __m128d DivOne( __m128d mDst, __m128d mSrc ); // SSE2
    ...
    // Minimum Value
    inline __m128 MinOne( __m128 mDst, __m128 mSrc );    // SSE
    inline __m128d MinOne( __m128d mDst, __m128d mSrc ); // SSE2
    ...
    // Maximum Value
    inline __m128 MaxOne( __m128 mDst, __m128 mSrc );    // SSE
    inline __m128d MaxOne( __m128d mDst, __m128d mSrc ); // SSE2
    ...
    namespace Signed {
        ...
        // Addition, Saturated
        inline __m128i AddSat8( __m128i mDst, __m128i mSrc );  // SSE2
        inline __m128i AddSat16( __m128i mDst, __m128i mSrc ); // SSE2

        inline __m256i AddSat8( __m256i mDst, __m256i mSrc );  // AVX2
        inline __m256i AddSat16( __m256i mDst, __m256i mSrc ); // AVX2
        ...
        inline __m128i HAddSat16( __m128i mSrc1, __m128i mSrc2 ); // SSSE3

        inline __m256i HAddSat16( __m256i mSrc1, __m256i mSrc2 ); // AVX2
        ...
        inline __m128i SubSat8( __m128i mDst, __m128i mSrc );  // SSE2
        inline __m128i SubSat16( __m128i mDst, __m128i mSrc ); // SSE2

        inline __m256i SubSat8( __m256i mDst, __m256i mSrc );  // AVX2
        inline __m256i SubSat16( __m256i mDst, __m256i mSrc ); // AVX2
        ...
        inline __m128i HSubSat16( __m128i mSrc1, __m128i mSrc2 ); // SSSE3

        inline __m256i HSubSat16( __m256i mSrc1, __m256i mSrc2 ); // AVX2

        // Multiplication
        inline __m128i Mul16L( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Mul16H( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Mul32( __m128i mDst, __m128i mSrc );  // SSE41
        inline __m128i Mul32L( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Mul64L( __m128i mDst, __m128i mSrc ); // SSE41

        inline __m256i Mul16L( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Mul16H( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Mul32( __m256i mDst, __m256i mSrc );  // AVX2
        inline __m256i Mul32L( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Mul64L( __m256i mDst, __m256i mSrc ); // AVX2
        ...
        // Division
        inline __m128i Div8( __m128i mDst, __m128i mSrc );  // SSE2
        inline __m128i Div16( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Div32( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Div64( __m128i mDst, __m128i mSrc ); // SSE2

        inline __m256i Div8( __m256i mDst, __m256i mSrc );  // AVX
        inline __m256i Div16( __m256i mDst, __m256i mSrc ); // AVX
        inline __m256i Div32( __m256i mDst, __m256i mSrc ); // AVX
        inline __m256i Div64( __m256i mDst, __m256i mSrc ); // AVX

        // Modulo
        inline __m128i Mod8( __m128i mDst, __m128i mSrc );  // SSE2
        inline __m128i Mod16( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Mod32( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Mod64( __m128i mDst, __m128i mSrc ); // SSE2

        inline __m256i Mod8( __m256i mDst, __m256i mSrc );  // AVX
        inline __m256i Mod16( __m256i mDst, __m256i mSrc ); // AVX
        inline __m256i Mod32( __m256i mDst, __m256i mSrc ); // AVX
        inline __m256i Mod64( __m256i mDst, __m256i mSrc ); // AVX

        // Division and Modulo
        inline __m128i DivMod32( __m128i * outMod, __m128i mDst, __m128i mSrc ); // SSE2

        inline __m256i DivMod32( __m256i * outMod, __m256i mDst, __m256i mSrc ); // AVX

        // Minimum Value
        inline __m128i Min8( __m128i mDst, __m128i mSrc );  // SSE41
        inline __m128i Min16( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Min32( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Min64( __m128i mDst, __m128i mSrc ); // SSE41

        inline __m256i Min8( __m256i mDst, __m256i mSrc );  // AVX2
        inline __m256i Min16( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Min32( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Min64( __m256i mDst, __m256i mSrc ); // AVX2

        // Maximum Value
        inline __m128i Max8( __m128i mDst, __m128i mSrc );  // SSE41
        inline __m128i Max16( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Max32( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Max64( __m128i mDst, __m128i mSrc ); // SSE41

        inline __m256i Max8( __m256i mDst, __m256i mSrc );  // AVX2
        inline __m256i Max16( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Max32( __m256i mDst, __m256i mSrc ); // AVX2
        inline __m256i Max64( __m256i mDst, __m256i mSrc ); // AVX2
    ...
    namespace Unsigned {
        ...
        // Multiplication
        inline __m128i Mul16H( __m128i mDst, __m128i mSrc ); // SSE2
        inline __m128i Mul32( __m128i mDst, __m128i mSrc );  // SSE2
        ...
        // Minimum Value
        inline __m128i Min8( __m128i mDst, __m128i mSrc );  // SSE2
        inline __m128i Min16( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Min32( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Min64( __m128i mDst, __m128i mSrc ); // SSE41
        ...
        // Maximum Value
        inline __m128i Max8( __m128i mDst, __m128i mSrc );  // SSE2
        inline __m128i Max16( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Max32( __m128i mDst, __m128i mSrc ); // SSE41
        inline __m128i Max64( __m128i mDst, __m128i mSrc ); // SSE41
