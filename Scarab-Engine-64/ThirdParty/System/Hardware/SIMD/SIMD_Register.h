...
namespace SIMD { namespace Register {
    ...
    namespace Interleave {
        ...
        // Float manipulation
        inline __m128 Low( __m128 mSrcEven, __m128 mSrcOdd ); // SSE
        inline __m128 High( __m128 mSrcEven, __m128 mSrcOdd ); // SSE

        inline __m256 LowX2( __m256 mSrcEven, __m256 mSrcOdd ); // AVX
        inline __m256 HighX2( __m256 mSrcEven, __m256 mSrcOdd ); // AVX

        // Double manipulation
        inline __m128d Low( __m128d mSrcEven, __m128d mSrcOdd ); // SSE2
        inline __m128d High( __m128d mSrcEven, __m128d mSrcOdd ); // SSE2

        inline __m256d LowX2( __m256d mSrcEven, __m256d mSrcOdd ); // AVX
        inline __m256d HighX2( __m256d mSrcEven, __m256d mSrcOdd ); // AVX

        // Integer manipulation
        inline __m128i LowInt8( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i HighInt8( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i LowInt16( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i HighInt16( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i LowInt32( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i HighInt32( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i LowInt64( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2
        inline __m128i HighInt64( __m128i mSrcEven, __m128i mSrcOdd ); // SSE2

        inline __m256i LowInt8X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i HighInt8X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i LowInt16X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i HighInt16X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i LowInt32X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i HighInt32X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i LowInt64X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
        inline __m256i HighInt64X2( __m256i mSrcEven, __m256i mSrcOdd ); // AVX2
    ...
    namespace Spread2 {
        ...
        // Double manipulation
        inline __m128d AA( __m128d mSrc ); // SSE3 or AVX2
        inline __m128d BB( __m128d mSrc ); // AVX

        // Int64 manipulation
        inline __m128i AA( __m128i mSrc ); // AVX2

        // 128-bits Lane manipulation
        inline __m256i AA( __m256i mSrc ); // AVX2
    ...
    namespace Spread4 {
        ...
        // Float manipulation
        inline __m128 AACC( __m128 mSrc ); // SSE3
        inline __m128 BBDD( __m128 mSrc ); // SSE3
        inline __m128 AAAA( __m128 mSrc ); // AVX2

        // Double manipulation
        inline __m256d AACC( __m256d mSrc ); // AVX
        inline __m256d BBDD( __m256d mSrc ); // AVX2
        inline __m256d AAAA( __m256d mSrc ); // AVX2

        // Int32 manipulation
        inline __m128i AAAA( __m128i mSrc ); // AVX2

        // Int64 manipulation
        inline __m256i AAAA( __m256i mSrc ); // AVX2
    ...
    namespace Spread8 {
        ...
        // Float manipulation
        inline __m256 AACCEEGG( __m256 mSrc ); // AVX
        inline __m256 BBDDFFHH( __m256 mSrc ); // AVX
        inline __m256 AAAAAAAA( __m256 mSrc ); // AVX2

        // Int16 manipulation
        inline __m128i AAAAAAAA( __m128i mSrc ); // AVX2

        // Int32 manipulation
        inline __m256i AAAAAAAA( __m256i mSrc ); // AVX2
    ...
    namespace Shuffle2 {
        ...
        // Double manipulation
            // 2-Swap
        inline __m128d BA( __m128d mSrc ); // AVX

        // Int64 manipulation
            // 2-Swap
        inline __m128i BA( __m128i mSrc ); // AVX2

        // 128-bits Lane manipulation
            // 2-Swap
        inline __m256 BA( __m256 mSrc );   // AVX
        inline __m256d BA( __m256d mSrc ); // AVX
        inline __m256i BA( __m256i mSrc ); // AVX2
    ...
    namespace Shuffle4 {
        ...
        // Float manipulation
            // 1 Swap
        inline __m128 BACD( __m128 mSrc ); // AVX
        inline __m128 ABDC( __m128 mSrc ); // AVX
        inline __m128 ACBD( __m128 mSrc ); // AVX
        inline __m128 DBCA( __m128 mSrc ); // AVX

            // Circular
        inline __m128 BCDA( __m128 mSrc ); // AVX
        inline __m128 CDAB( __m128 mSrc ); // AVX
        inline __m128 DABC( __m128 mSrc ); // AVX

            // Mirror Circular
        inline __m128 DCBA( __m128 mSrc ); // AVX
        inline __m128 CBAD( __m128 mSrc ); // AVX
        inline __m128 BADC( __m128 mSrc ); // AVX
        inline __m128 ADCB( __m128 mSrc ); // AVX

        // Double manipulation
            // 1-Swap
        inline __m256d BACD( __m256d mSrc ); // AVX
        inline __m256d ABDC( __m256d mSrc ); // AVX
        inline __m256d ACBD( __m256d mSrc ); // AVX2
        inline __m256d DBCA( __m256d mSrc ); // AVX2

            // Circular
        inline __m256d BCDA( __m256d mSrc ); // AVX2
        inline __m256d CDAB( __m256d mSrc ); // AVX2
        inline __m256d DABC( __m256d mSrc ); // AVX2

            // Mirror Circular
        inline __m256d DCBA( __m256d mSrc ); // AVX2
        inline __m256d CBAD( __m256d mSrc ); // AVX2
        inline __m256d BADC( __m256d mSrc ); // AVX
        inline __m256d ADCB( __m256d mSrc ); // AVX2

        // Int32 manipulation
            // 1-Swap
        inline __m128i BACD( __m128i mSrc ); // SSE2
        inline __m128i ABDC( __m128i mSrc ); // SSE2
        inline __m128i ACBD( __m128i mSrc ); // SSE2
        inline __m128i DBCA( __m128i mSrc ); // SSE2

            // Circular
        inline __m128i BCDA( __m128i mSrc ); // SSE2
        inline __m128i CDAB( __m128i mSrc ); // SSE2
        inline __m128i DABC( __m128i mSrc ); // SSE2

            // Mirror Circular
        inline __m128i DCBA( __m128i mSrc ); // SSE2
        inline __m128i CBAD( __m128i mSrc ); // SSE2
        inline __m128i BADC( __m128i mSrc ); // SSE2
        inline __m128i ADCB( __m128i mSrc ); // SSE2

        // Int64 manipulation
            // 1-Swap
        inline __m256i BACD( __m256i mSrc ); // AVX2
        inline __m256i ABDC( __m256i mSrc ); // AVX2
        inline __m256i ACBD( __m256i mSrc ); // AVX2
        inline __m256i DBCA( __m256i mSrc ); // AVX2

            // Circular
        inline __m256i BCDA( __m256i mSrc ); // AVX2
        inline __m256i CDAB( __m256i mSrc ); // AVX2
        inline __m256i DABC( __m256i mSrc ); // AVX2

            // Mirror Circular
        inline __m256i DCBA( __m256i mSrc ); // AVX2
        inline __m256i CBAD( __m256i mSrc ); // AVX2
        inline __m256i BADC( __m256i mSrc ); // AVX2
        inline __m256i ADCB( __m256i mSrc ); // AVX2
    ...
    namespace Shuffle8 {
        ...
        inline __m256 BACDFEGH( __m256 mSrc ); // AVX
        inline __m256 ABDCEFHG( __m256 mSrc ); // AVX
        inline __m256 ACBDEGFH( __m256 mSrc ); // AVX
        inline __m256 DBCAHFGE( __m256 mSrc ); // AVX

            // Circular, Within 128-bits Lanes
        inline __m256 BCDAFGHE( __m256 mSrc ); // AVX
        inline __m256 CDABGHEF( __m256 mSrc ); // AVX
        inline __m256 DABCHEFG( __m256 mSrc ); // AVX

            // Mirror Circular, Within 128-bits Lanes
        inline __m256 DCBAHGFE( __m256 mSrc ); // AVX
        inline __m256 CBADGFEH( __m256 mSrc ); // AVX
        inline __m256 BADCFEHG( __m256 mSrc ); // AVX
        inline __m256 ADCBEHGF( __m256 mSrc ); // AVX

        // Int16 manipulation
            // 1-Swap
        inline __m128i BACDEFGH( __m128i mSrc ); // SSE2
        inline __m128i ABDCEFGH( __m128i mSrc ); // SSE2
        inline __m128i ACBDEFGH( __m128i mSrc ); // SSE2
        inline __m128i DBCAEFGH( __m128i mSrc ); // SSE2

        inline __m128i ABCDFEGH( __m128i mSrc ); // SSE2
        inline __m128i ABCDEFHG( __m128i mSrc ); // SSE2
        inline __m128i ABCDEGFH( __m128i mSrc ); // SSE2
        inline __m128i ABCDHFGE( __m128i mSrc ); // SSE2

            // Circular
        inline __m128i BCDAEFGH( __m128i mSrc ); // SSE2
        inline __m128i CDABEFGH( __m128i mSrc ); // SSE2
        inline __m128i DABCEFGH( __m128i mSrc ); // SSE2

        inline __m128i ABCDFGHE( __m128i mSrc ); // SSE2
        inline __m128i ABCDGHEF( __m128i mSrc ); // SSE2
        inline __m128i ABCDHEFG( __m128i mSrc ); // SSE2

            // Mirror Circular
        inline __m128i DCBAEFGH( __m128i mSrc ); // SSE2
        inline __m128i CBADEFGH( __m128i mSrc ); // SSE2
        inline __m128i BADCEFGH( __m128i mSrc ); // SSE2
        inline __m128i ADCBEFGH( __m128i mSrc ); // SSE2

        inline __m128i ABCDHGFE( __m128i mSrc ); // SSE2
        inline __m128i ABCDGFEH( __m128i mSrc ); // SSE2
        inline __m128i ABCDFEHG( __m128i mSrc ); // SSE2
        inline __m128i ABCDEHGF( __m128i mSrc ); // SSE2

        // Int32 manipulation
            // 1-Swap, Within 128-bits Lanes
        inline __m256i BACDFEGH( __m256i mSrc ); // AVX2
        inline __m256i ABDCEFHG( __m256i mSrc ); // AVX2
        inline __m256i ACBDEGFH( __m256i mSrc ); // AVX2
        inline __m256i DBCAHFGE( __m256i mSrc ); // AVX2

            // Circular, Within 128-bits Lanes
        inline __m256i BCDAFGHE( __m256i mSrc ); // AVX2
        inline __m256i CDABGHEF( __m256i mSrc ); // AVX2
        inline __m256i DABCHEFG( __m256i mSrc ); // AVX2

            // Mirror Circular, Within 128-bits Lanes
        inline __m256i DCBAHGFE( __m256i mSrc ); // AVX2
        inline __m256i CBADGFEH( __m256i mSrc ); // AVX2
        inline __m256i BADCFEHG( __m256i mSrc ); // AVX2
        inline __m256i ADCBEHGF( __m256i mSrc ); // AVX2
    ...
    namespace ShuffleIndexed {
        ...
        inline __m128i Make4Indices( const Int32 * arrIndices );
        inline __m128 FourFloat( __m128 mSrc, __m128i mIndices4 ); // AVX

        inline __m256i Make8Indices( const Int32 * arrIndices );
        inline __m256 FourFloatX2( __m256 mSrc, __m256i mIndices4 );  // AVX
        inline __m256 EightFloat( __m256 mSrc, __m256i mIndices8 );   // AVX2
        inline __m256i EightInt32( __m256i mSrc, __m256i mIndices8 ); // AVX2

        // BEWARE THOSE MUST BE SHIFTED LEFT BY 1 !!!
        inline __m128i Make2Indices( const Int64 * arrIndices );
        inline __m128d TwoDouble( __m128d mSrc, __m128i mIndices2 ); // AVX

        // BEWARE THOSE MUST BE SHIFTED LEFT BY 1 !!!
        inline __m256i Make4Indices( const Int64 * arrIndices );
        inline __m256d TwoDoubleX2( __m256d mSrc, __m256i mIndices2 ); // AVX

        // Index Sign Bit = Set to Zero Flag
        inline __m128i Make16Indices( const Int8 * arrIndices_Z );
        inline __m128i SixteenInt8( __m128i mSrc, __m128i mIndices16_Z ); // SSSE3

        // Index Sign Bit = Set to Zero Flag
        inline __m256i Make32Indices( const Int8 * arrIndices_Z );
        inline __m256i SixteenInt8X2( __m256i mSrc, __m256i mIndices16_Z ); // AVX2

    };

    // Blend
    namespace Blend {
        //inline __m128 Float( __m128 mDst, __m128 mSrc, Int iMask4 );    // SSE41
        inline __m128 Float( __m128 mDst, __m128 mSrc, __m128 mSigns ); // SSE41

        //inline __m128d Double( __m128d mDst, __m128d mSrc, Int iMask2 );     // SSE41
        inline __m128d Double( __m128d mDst, __m128d mSrc, __m128d mSigns ); // SSE41

        inline __m128i Int8( __m128i mDst, __m128i mSrc, __m128i mSigns ); // SSE41
        //inline __m128i Int16( __m128i mDst, __m128i mSrc, Int iMask8 );    // SSE41
        //inline __m128i Int32( __m128i mDst, __m128i mSrc, Int iMask4 );    // AVX2

        //inline __m256 Float( __m256 mDst, __m256 mSrc, Int iMask8 );    // AVX
        inline __m256 Float( __m256 mDst, __m256 mSrc, __m256 mSigns ); // AVX

        //inline __m256d Double( __m256d mDst, __m256d mSrc, Int iMask4 );     // AVX
        inline __m256d Double( __m256d mDst, __m256d mSrc, __m256d mSigns ); // AVX

        inline __m256i Int8( __m256i mDst, __m256i mSrc, __m256i mSigns ); // AVX2
        //inline __m256i Int16( __m256i mDst, __m256i mSrc, Int iMask8 );    // AVX2
        //inline __m256i Int32( __m256i mDst, __m256i mSrc, Int iMask8 );    // AVX2
    };
