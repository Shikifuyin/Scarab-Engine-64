...
// _M_IX86 / _M_X64   : Target Architecture
// _WIN32 / _WIN64    : Microsoft Windows OS
// __linux__	      : GNU Linux OS
// __cplusplus        : Using C++ compiler
// UNICODE / _UNICODE : Unicode charset
...
// Architecture
#if defined(_M_X64)
    #define SCARAB_ARCHITECTURE_X64
#elif defined(_M_IX86)
	#define SCARAB_ARCHITECTURE_X86
#else
...
static const DWord _FLOAT_NAN_REPR = 0x7fc00000;
...
static const QWord _DOUBLE_NAN_REPR = 0x7ff8000000000000;
