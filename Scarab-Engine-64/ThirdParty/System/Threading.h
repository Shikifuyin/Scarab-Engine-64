...
typedef unsigned long (__stdcall * HThreadRoutine)( Void* );
...
typedef struct _ProcessLockListNode {
    struct _ProcessLockListNode * Flink;
    struct _ProcessLockListNode * Blink;
} ProcessLockListNode;

typedef struct _CriticalSectionDebugDesc {
    Word Type;
    Word CreatorBackTraceIndex;
    struct _CriticalSectionDesc * CriticalSection;
    ProcessLockListNode ProcessLocksList;
    DWord EntryCount;
    DWord ContentionCount;
    DWord Flags;
    Word CreatorBackTraceIndexHigh;
    Word SpareWORD;
} CriticalSectionDebugDesc;

typedef struct _CriticalSectionDesc {
...
private:
    ...
    // Handle
    CriticalSectionDesc m_hCriticalSection;
};
